import pygame
import amu.components.transform
import pytest
...
class TestTransform:
    def test_transform_initialization(self):
        # object to test
        t_transf = amu.components.transform.Transform2D()
    ...
    def test_set_scale(self, t_scale_x, t_scale_y, t_should_pass):
             t_transf = amu.components.transform.Transform2D((0, 0), 0, (1, 1))
             if t_should_pass:
